...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '正经人谁写日记啊',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '图大猫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Digital electronic，徒步爬山、足球、羽毛球球、阅读、game（塞尔达是天😎）', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-delta-sepia.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tuuu1789@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POST_LIST_STYLE: process.env.NEXT_PUBLIC_POST_LIST_STYLE || 'scoll', // ['page','scroll] 文章列表样式:页码分页、单页滚动加载
